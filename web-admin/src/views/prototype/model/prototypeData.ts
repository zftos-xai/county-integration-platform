...
export const scenarios: Scenario[] = [
  {
    ...
    steps: ['10:53:00 第2版发送后目标系统返回结果未知', '11:05:00 合成查询：双方业务号相同，各1条', '11:05:00 HIS仅有第1版，第2版继续核查'],
  },
  {
  ...
  },
  {
    ...
    receipt: '演示业务目标系统返回结果 SIM-RCPT-0032；报告版本 1',
    question: '申请单、报告版本及 HIS 展示状态能否一致？',
    steps: ['10:41:50 LIS 按申请单号取得申请数据', '10:42:10 医技系统审核报告', '10:42:19 回写 HIS 并取得演示业务目标系统返回结果', '10:42:20 对照申请单与报告版本完成核对'],
  },
  {
