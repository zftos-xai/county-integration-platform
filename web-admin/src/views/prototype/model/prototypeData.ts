...
export const scenarios: Scenario[] = [
  {
    ...
    comparison: { sourceVersion: '2', targetVersion: '1', sourceResult: '已审核', targetResult: '第1版已写入', basis: 'SIM-QUERY-COMPARE-053' },
    steps: ['10:53:00 第2版发送后目标系统返回结果未知', '11:05:00 查询双方业务号相同，各1条', '11:05:00 HIS仅有第1版，第2版继续核查'],
  },
  {
    id: 'DESIGN-09', domain: '报告查询', title: '报告来源系统暂时不可用', status: '查询失败',
    direction: '基层系统 → PACS', interfaceCode: 'SIM-REPORT-QUERY', interfaceName: '查询检查报告', interfaceVersion: '规则V1', interfaceLinkStatus: '已关联', organization: '示例青禾镇卫生院', organizationCode: 'SIM-ORG-001',
  ...
  },
  {
    ...
    direction: '院内系统 → 健康云', interfaceCode: 'ACB666576D94A008', interfaceName: '健康档案上传', interfaceVersion: '规则V1', interfaceLinkStatus: '已关联', organization: '示例青禾镇卫生院', organizationCode: 'SIM-ORG-001',
    ...
    steps: ['10:50:00 接收档案请求', '10:51:00 发出请求，后续记录未包含在恢复点', '11:10:00 恢复旧记录后暂停发送并核查结果'],
  },
  {
  ...
  },
  {
    ...
    direction: '院内系统 → 健康云', interfaceCode: 'ACB666576D94A000', interfaceName: '体检信息上传', interfaceVersion: '规则V1', interfaceLinkStatus: '已关联', organization: '示例青禾镇卫生院', organizationCode: 'SIM-ORG-001',
    ...
    steps: ['10:52:00 请求发送超时', '11:00:00 到期后停止发送', '11:01:00 临时数据清理失败，保留失败记录'],
  },
  {
  ...
  },
  {
    ...
    receipt: '发送超时；暂存期限已到，暂停后续发送', question: '如何清理到期数据，同时继续核查业务结果？',
    steps: ['09:00:00 已受理请求', '09:01:00 发送超时，目标结果未知', '11:00:00 达到暂存期限，自动暂停'],
  },
  {
    id: 'DESIGN-01', domain: '健康档案', title: '上传超时后目标系统返回结果不明', status: '结果未知',
    direction: '院内系统 → 健康云', interfaceCode: 'ACB666576D94A008', interfaceName: '健康档案上传', interfaceVersion: '规则V1', interfaceLinkStatus: '已关联',
    ...
    receipt: '未取得明确业务目标系统返回结果；id / sjlyId 待核查',
    question: '目标端是否已写入，能否按源业务主键补查？',
    steps: ['09:26:43 已受理源记录 SIM-EHR-240914-018', '09:26:44 机构与必填字段校验通过', '09:27:14 发送超时，未取得明确业务目标系统返回结果', '待核查目标结果，不自动重发'],
  },
  {
  ...
  },
  {
    ...
    direction: '院内系统 → 健康云', interfaceCode: 'ACB666576D94A000', interfaceName: '体检信息上传', interfaceVersion: '规则V1', interfaceLinkStatus: '已关联',
    organization: '示例青禾镇卫生院', organizationCode: 'SIM-ORG-001',
    sourceSystem: '院内 HIS', targetSystem: '健康档案云平台',
    sourceRecordId: 'SIM-EXAM-240914-011', patientRef: 'SIM-PAT-011',
    requestId: 'SIM-REQ-20260914-0011', occurredAt: '2026-09-14 09:12:06',
    receipt: '本地已受理；目标目标系统返回结果待取得',
    question: '已受理不等于目标端处理成功。',
    steps: ['09:12:05 原业务系统完成体检审核', '09:12:06 平台可靠保存源记录', '09:12:06 返回跟踪编号和已受理状态', '等待明确业务目标系统返回结果后再核对'],
  },
  {
    id: 'DESIGN-05', domain: '检验报告', title: '审核报告回写并取得目标系统返回结果', status: '处理成功',
    ...
    receipt: '目标系统返回结果 SIM-RCPT-0032；报告版本 1',
    question: '申请单、报告版本及 HIS 展示状态能否一致？',
    steps: ['10:41:50 LIS 按申请单号取得申请数据', '10:42:10 医技系统审核报告', '10:42:19 回写 HIS 并取得目标系统返回结果', '10:42:20 对照申请单与报告版本完成核对'],
  },
  {
