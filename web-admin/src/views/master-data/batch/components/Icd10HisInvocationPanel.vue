...
import { ChevronLeft, ChevronRight, FileWarning } from 'lucide-vue-next'
...
<template>
  <section class="record-card his-invocation-card">
    <div class="card-heading">
      ...
      <span v-if="page" class="record-total">{{ page.total }} 次调用</span>
    </div>
...
@media (max-width: 760px) { .card-heading { align-items: flex-start; flex-direction: column; } .invocation-pagination { justify-content: space-between; } }
</style>
