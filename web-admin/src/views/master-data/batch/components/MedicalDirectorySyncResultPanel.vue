...
<template>
  <section class="medical-result-panel">
    <header><h3>中药、西药、诊疗与耗材同步结果</h3></header>
...
<style scoped>
.medical-result-panel{border:1px solid #dce5e7;border-radius:6px;background:#fff}
.medical-result-panel>header{padding:13px 17px;border-bottom:1px solid #e9eef0}
.medical-result-panel h3{margin:0;color:#2d424b;font-size:15px}
.medical-result-panel p{margin:5px 0 0;color:#718189;font-size:12px;line-height:1.55}
