...
const persistenceContracts = new Map([
  ...
  ['cn.zqkj.platform.masterdata.domain.model.HospitalDirectoryRecord', ['md_hospital_directory', 'org_organization', 'md_sync_batch', 'md_hospital_directory_relation']],
  ['cn.zqkj.platform.masterdata.domain.model.HospitalDirectoryRelationRecord', ['md_hospital_directory_relation']],
  ['cn.zqkj.platform.masterdata.domain.model.HospitalDirectorySourceRecord', ['md_hospital_directory']],
  ['cn.zqkj.platform.masterdata.domain.model.HospitalDirectorySyncResult', ['md_hospital_directory_sync_result']],
  ['cn.zqkj.platform.masterdata.domain.model.HospitalDirectoryTypeCount', ['md_hospital_directory', 'org_organization']],
  ['cn.zqkj.platform.masterdata.domain.model.MasterDataBatchSnapshot', ['md_sync_batch', 'org_organization']],
  ['cn.zqkj.platform.system.domain.model.DictionaryItem', ['sys_dictionary_item', 'sys_dictionary_type']],
  ['cn.zqkj.platform.system.domain.model.DictionaryType', ['sys_dictionary_type']],
  ['cn.zqkj.platform.system.domain.model.ExternalEndpoint', ['sys_external_endpoint', 'org_organization', 'sys_external_endpoint_credential']],
  ['cn.zqkj.platform.system.domain.model.ExternalEndpointCredential', ['sys_external_endpoint_credential', 'sys_external_endpoint']],
  ['cn.zqkj.platform.system.domain.model.ExternalEndpointScope', ['sys_external_endpoint', 'sys_external_system', 'org_organization', 'sys_external_endpoint_credential']],
  ['cn.zqkj.platform.system.domain.model.ExternalSystem', ['sys_external_system']],
  ['cn.zqkj.platform.system.domain.model.ManagedUserSummary', ['sys_user', 'org_organization']],
  ['cn.zqkj.platform.system.domain.model.ManagementAuditEvent', ['audit_management_event']],
  ['cn.zqkj.platform.system.domain.model.ParameterValue', ['sys_parameter_value', 'org_organization']],
  ['cn.zqkj.platform.system.domain.model.RoleSummary', ['sys_role', 'sys_role_permission']],
  ['cn.zqkj.platform.system.domain.model.UserAccount', ['sys_user', 'org_organization']],
  ['cn.zqkj.platform.system.domain.vo.OrganizationVO', ['org_organization']],
  ['cn.zqkj.platform.system.domain.vo.PermissionVO', ['sys_permission']],
]);
