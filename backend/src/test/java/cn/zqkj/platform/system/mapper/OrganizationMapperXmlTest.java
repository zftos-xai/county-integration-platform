...
class OrganizationMapperXmlTest {
    ...
    void bindsNullableOrganizationFieldsWithExplicitJdbcTypes() {
        ...
        MappedStatement statement = configuration.getMappedStatement(
                "cn.zqkj.platform.system.mapper.OrganizationMapper.create"
        );
        Map<String, Object> parameters = new HashMap<>();
        parameters.put("command", new cn.zqkj.platform.system.domain.dto.CreateOrganizationCommand(
    ...
    void mapsPrimitiveConstructorTypesWithoutBoxingMismatch() {
        ...
        ResultMap resultMap = configuration.getResultMap(
                "cn.zqkj.platform.system.mapper.OrganizationMapper.organizationView"
        );
    ...
    private Configuration parseMapper() {
        String resource = "mapper/system/OrganizationMapper.xml";
