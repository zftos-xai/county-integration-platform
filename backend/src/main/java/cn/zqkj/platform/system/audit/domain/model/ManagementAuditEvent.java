package cn.zqkj.platform.system.audit.domain.model;
 ...
 * 不可变的管理审计事件快照。
 *
 * <p>对应表：{@code dbo.audit_management_event}（管理审计事件表）。</p>
 *
 * <p>业务说明：以追加方式保存操作人、动作、对象、结果、机构快照和请求编号；
 * 不承载密码、凭证、连接地址或医疗正文。</p>
 *
 * @param id 主键
 * @param occurredAt 发生UTC时间
 * @param actorUserId 可选操作人主键
