...
/** @param id 主键 @param systemCode 稳定代码 @param systemName 名称 @param description 用途 @param enabled 是否启用 @param createdAt 创建UTC时间 @param updatedAt 修改UTC时间 @param version Base64并发版本 */
