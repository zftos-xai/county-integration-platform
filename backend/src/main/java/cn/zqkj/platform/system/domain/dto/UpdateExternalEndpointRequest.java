...
/** @param environment 环境 @param organizationId 可选机构 @param baseUrl HTTP或HTTPS地址 @param connectTimeoutMs 连接超时 @param readTimeoutMs 读取超时 @param authentication 可选新认证信息；空值表示保留现有配置 @param enabled 是否启用 @param version Base64并发版本 */
