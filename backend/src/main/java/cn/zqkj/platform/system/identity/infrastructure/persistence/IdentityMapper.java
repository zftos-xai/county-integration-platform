...
public interface IdentityMapper {
     ...
     * @return 新角色主键
     */
    long insertRole(@Param("roleCode") String roleCode, @Param("roleName") String roleName, @Param("actor") String actor);
     ...
     * @return 实际影响行数
     */
    int insertUserRole(@Param("userId") long userId, @Param("roleId") long roleId, @Param("actor") String actor);
