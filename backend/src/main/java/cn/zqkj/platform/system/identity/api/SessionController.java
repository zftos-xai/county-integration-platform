...
public class SessionController {
     ...
     */
    @GetMapping("/csrf")
    public ApiResponse<CsrfTokenView> csrf(CsrfToken csrfToken) {
        return ApiResponse.success(new CsrfTokenView(
     ...
     */
    @PostMapping("/login")
    public ApiResponse<CurrentUserView> login(
        ...
        return ApiResponse.success(CurrentUserView.from((PlatformUserPrincipal) authentication.getPrincipal()));
    }
     ...
     */
    @GetMapping("/current")
    public ApiResponse<CurrentUserView> current(@AuthenticationPrincipal PlatformUserPrincipal principal) {
        return ApiResponse.success(CurrentUserView.from(principal));
    }
