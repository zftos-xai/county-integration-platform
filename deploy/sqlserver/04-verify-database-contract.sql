...
VALUES
    ...
    (N'dbo', N'md_icd10_diagnosis', N'id', N'bigint', NULL, NULL, NULL, 0, 1, 0),
    (N'dbo', N'md_icd10_diagnosis', N'source_system_code', N'nvarchar', 128, NULL, NULL, 0, 0, 0),
    (N'dbo', N'md_icd10_diagnosis', N'diagnosis_category', N'nvarchar', 32, NULL, NULL, 0, 0, 0),
    (N'dbo', N'md_icd10_diagnosis', N'disease_code', N'nvarchar', 100, NULL, NULL, 0, 0, 0),
    (N'dbo', N'md_icd10_diagnosis', N'disease_name', N'nvarchar', 128, NULL, NULL, 0, 0, 0),
    (N'dbo', N'md_icd10_diagnosis', N'mnemonic_code', N'nvarchar', 128, NULL, NULL, 1, 0, 0),
    (N'dbo', N'md_icd10_diagnosis', N'remark', N'nvarchar', 200, NULL, NULL, 1, 0, 0),
    (N'dbo', N'md_icd10_diagnosis', N'source_created_at', N'nvarchar', 100, NULL, NULL, 0, 0, 0),
    (N'dbo', N'md_icd10_diagnosis', N'source_disease_id', N'nvarchar', 64, NULL, NULL, 1, 0, 0),
    (N'dbo', N'md_icd10_diagnosis', N'first_seen_batch_id', N'bigint', NULL, NULL, NULL, 0, 0, 0),
    (N'dbo', N'md_icd10_diagnosis', N'latest_batch_id', N'bigint', NULL, NULL, NULL, 0, 0, 0),
    (N'dbo', N'md_icd10_diagnosis', N'first_seen_at', N'datetime2', NULL, NULL, 3, 0, 0, 0),
    (N'dbo', N'md_icd10_diagnosis', N'last_seen_at', N'datetime2', NULL, NULL, 3, 0, 0, 0),
    (N'dbo', N'md_icd10_diagnosis', N'created_at', N'datetime2', NULL, NULL, 3, 0, 0, 0),
    (N'dbo', N'md_icd10_diagnosis', N'updated_at', N'datetime2', NULL, NULL, 3, 0, 0, 0),
    (N'dbo', N'md_icd10_diagnosis', N'row_version', N'rowversion', NULL, NULL, NULL, 0, 0, 0),
    (N'dbo', N'md_icd10_sync_result', N'batch_id', N'bigint', NULL, NULL, NULL, 0, 0, 0),
    (N'dbo', N'md_icd10_sync_result', N'diagnosis_category', N'nvarchar', 32, NULL, NULL, 0, 0, 0),
    (N'dbo', N'md_icd10_sync_result', N'outcome_status', N'nvarchar', 64, NULL, NULL, 0, 0, 0),
    (N'dbo', N'md_icd10_sync_result', N'declared_count', N'bigint', NULL, NULL, NULL, 1, 0, 0),
    (N'dbo', N'md_icd10_sync_result', N'returned_count', N'bigint', NULL, NULL, NULL, 0, 0, 0),
    (N'dbo', N'md_icd10_sync_result', N'duplicate_count', N'bigint', NULL, NULL, NULL, 0, 0, 0),
    (N'dbo', N'md_icd10_sync_result', N'invalid_count', N'bigint', NULL, NULL, NULL, 0, 0, 0),
    (N'dbo', N'md_icd10_sync_result', N'conflict_count', N'bigint', NULL, NULL, NULL, 0, 0, 0),
    (N'dbo', N'md_icd10_sync_result', N'created_count', N'bigint', NULL, NULL, NULL, 0, 0, 0),
    (N'dbo', N'md_icd10_sync_result', N'updated_count', N'bigint', NULL, NULL, NULL, 0, 0, 0),
    (N'dbo', N'md_icd10_sync_result', N'unchanged_count', N'bigint', NULL, NULL, NULL, 0, 0, 0),
    (N'dbo', N'md_icd10_sync_result', N'active_count', N'bigint', NULL, NULL, NULL, 1, 0, 0),
    (N'dbo', N'md_icd10_sync_result', N'failure_summary', N'nvarchar', 1000, NULL, NULL, 1, 0, 0),
    (N'dbo', N'md_icd10_sync_result', N'finished_at', N'datetime2', NULL, NULL, 3, 0, 0, 0),
    (N'dbo', N'md_icd10_diagnosis', N'source_record_key', N'nvarchar', 128, NULL, NULL, 0, 0, 0),
    (N'dbo', N'md_icd10_his_invocation', N'id', N'bigint', NULL, NULL, NULL, 0, 1, 0),
    (N'dbo', N'md_icd10_his_invocation', N'batch_id', N'bigint', NULL, NULL, NULL, 0, 0, 0),
    (N'dbo', N'md_icd10_his_invocation', N'diagnosis_category', N'nvarchar', 32, NULL, NULL, 0, 0, 0),
    (N'dbo', N'md_icd10_his_invocation', N'invocation_sequence', N'int', NULL, NULL, NULL, 0, 0, 0),
    (N'dbo', N'md_icd10_his_invocation', N'trade_code', N'nvarchar', 32, NULL, NULL, 0, 0, 0),
    (N'dbo', N'md_icd10_his_invocation', N'page_start', N'bigint', NULL, NULL, NULL, 1, 0, 0),
    (N'dbo', N'md_icd10_his_invocation', N'page_end', N'bigint', NULL, NULL, NULL, 1, 0, 0),
    (N'dbo', N'md_icd10_his_invocation', N'request_summary', N'nvarchar', 1000, NULL, NULL, 0, 0, 0),
    (N'dbo', N'md_icd10_his_invocation', N'outcome_status', N'nvarchar', 64, NULL, NULL, 0, 0, 0),
    (N'dbo', N'md_icd10_his_invocation', N'result_code', N'nvarchar', 128, NULL, NULL, 1, 0, 0),
    (N'dbo', N'md_icd10_his_invocation', N'response_summary', N'nvarchar', 1000, NULL, NULL, 1, 0, 0),
